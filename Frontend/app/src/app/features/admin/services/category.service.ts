...
import {AddCategoryRequestDTO,AddCategoryResponseDTO,DeleteCategoryRequestDTO,DeleteCategoryResponseDTO,EditCategoryRequestDTO,EditCategoryResponseDTO,GetAllCategoryResponseDTO,
...
export class AdminCategoryService {
  ...
  getAllCategories(pagination: PaginationModel,): Observable<ApiResponse<GetAllCategoryResponseDTO>> {
    const requestBody = {
      Pagination: pagination,
    };
    return this.http.post<ApiResponse<GetAllCategoryResponseDTO>>(`${this.baseUrl}/get-all-categories`,requestBody,).pipe(
  ...
  addCategory(categoryName: string): Observable<ApiResponse<AddCategoryResponseDTO>> {
    ...
    return this.http.post<ApiResponse<AddCategoryResponseDTO>>(`${this.baseUrl}/add-category`,requestBody,);
  }
  ...
  deleteCategory(categoryId: string): Observable<ApiResponse<DeleteCategoryResponseDTO>> {
    ...
    return this.http.delete<ApiResponse<DeleteCategoryResponseDTO>>(`${this.baseUrl}/delete-category`,{body: requestBody,},
    );
  }
  ...
  updateCategory(categoryId: string,categoryName: string,): Observable<ApiResponse<EditCategoryResponseDTO>> {
    ...
    return this.http.post<ApiResponse<EditCategoryResponseDTO>>(`${this.baseUrl}/edit-category`,requestBody,);
  }
}
