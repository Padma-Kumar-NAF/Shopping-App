...
namespace ShoppingApp.Interfaces.ServicesInterface
{
    public interface ICartService
    {
        ...
        public Task<ApiResponse<OrderAllFromCartResponseDTO>> PlaceOrderAllFromCart(Guid UserId, Guid AddressId, string PaymentType, string PromoCode, bool UseWallet, string StripePaymentId = "");
